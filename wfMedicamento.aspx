<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="wfMedicamento.aspx.cs" Inherits="wfUsuarios" %>
                ...
                <div class="col-md-12" id="divClientes" runat="server">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Medicamentos</h3>&nbsp&nbsp&nbsp <label class="btn btn-xs btnAdd btn-info"><i class="fa fa-plus" style="color:#fff;"></i></label>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                                                ...
                                                <asp:Repeater ID="rpt1" runat="server" OnItemCommand="rpt1_ItemCommand" OnItemDataBound="rpt1_ItemDataBound">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr><td></td>
                                                            ...
                                                            <td><asp:label ID="lblMedida" runat="server" Text="-"></asp:Label></td>
            ...
            <div class="modal-dialog" role="document" id="divmodal">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="tituloModal">Medicamento: <small id="mal">    </small></h4>
                    </div>
                    <div class="modal-body" style="max-height: calc(100vh - 210px); overflow-y: auto;">
                        <div class="row">
                            ...
                            <div class="col-sm-6  col-xs-12">
                                ...
                                <asp:DropDownList ID="ddlMedia" CssClass="ddlMedia form-control" runat="server">
                                    <asp:ListItem Value="Gramos" Text="Gramos" />
                                    <asp:ListItem Value="Mililitros" Text="Mililitros" />
                                </asp:DropDownList>
                            </div><div class="col-sm-12  col-xs-12">
                                <label class="control-label">Descripcion</label>
                                <asp:TextBox runat="server"  TextMode="MultiLine"  CssClass =" form-control txtDescripcion " ID="txtDescripcion"></asp:TextBox>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentScript" Runat="Server">
    <script>
        ...
        $(".btnEdit").click(function () {
            ...
            $(".txtDescripcion").val($(this).attr("des"));
            $(".ddlMedia").val($(this).attr("med"));
